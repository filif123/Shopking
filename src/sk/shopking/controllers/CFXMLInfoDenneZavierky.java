 ...
 *
 */
public class CFXMLInfoDenneZavierky implements Initializable{

	private DenneZavierky vybranaDennaZavierka;
	...
	private void jbPrintAction(ActionEvent event) {
		...
		if (job != null){
			if (isNotCancel){
				...
				text.setY(15);
				text.setText(ZavierkaGenerator.generateSkupinaDennychZavierok(vybranaDennaZavierka));
	...
	public void setDennaZavierka(DenneZavierky zavierka) {
		...
		jtfCasZavierky.setText(new SimpleDateFormat("dd.MM.yyyy").format(vybranaDennaZavierka.getDatumZavierok()));
		...
		jtaOriginal.setText(ZavierkaGenerator.generateSkupinaDennychZavierok(vybranaDennaZavierka));
	}
