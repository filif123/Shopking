 ...
 *
 */
public class RocnaZavierka implements Zavierka{
	...
	public RocnaZavierka(int id,List<MesacnaZavierka> mesacneZavierky,Date casZavierky,Date intervalOd,Date intervalDo) {
		this.idZavierky = id;
		...
		this.setDatumOdProperty(new SimpleDateFormat("dd.MM.yyyy").format(this.intervalOd));
		this.setDatumDoProperty(new SimpleDateFormat("dd.MM.yyyy").format(this.intervalDo));
