...
/**
 * @author https://stackoverflow.com/questions/32613619/how-to-make-a-timespinner-in-javafx
 *
 */
public class TimeSpinner extends Spinner<LocalTime>{
    ...
    public TimeSpinner(LocalTime time) {
    	...
    	FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/resources/scenes/timeSpinner.fxml"));
        ...
        timeSpinner.getEditor().setTextFormatter(textFormatter);
        ...
        timeSpinner.getEditor().addEventHandler(InputEvent.ANY, e -> {
